...
public class Main {
  ...
  // In the opposite case, since value == 42F and value != 42F have the same bias, we cannot delete one of the selects
  ...
  // In the opposite case, since value == 42D and value != 42D have the same bias, we cannot delete one of the selects
