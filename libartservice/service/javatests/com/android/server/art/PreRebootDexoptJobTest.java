...
public class PreRebootDexoptJobTest {
    ...
    public void setUp() throws Exception {
        ...
        lenient()
                .doAnswer(invocation -> {
                    mPreRebootDexoptJob.setUpdateEngineReady();
                    return null;
                })
                .when(mUpdateEngine)
    ...
    private void checkStart(boolean expectedMapSnapshotsForOta) throws Exception {
    ...
    public void testStartWithUpdateEngineApi() throws Exception {
        checkStart(false /* expectedMapSnapshotsForOta */);
    ...
    public void testStartWithoutUpdateEngineApi() throws Exception {
        checkStart(true /* expectedMapSnapshotsForOta */);
