...
public class UtilsTest {
    ...
    public void TestGetRunningPidsForPackage() throws Exception {
        ...
        assertThat(Utils.getRunningPidsForPackage(am, pkgState1, UserHandle.of(0)))
                .containsExactly(1000, 1001, 1002);
        assertThat(Utils.getRunningPidsForPackage(am, pkgState1, UserHandle.of(1)))
