...
class ThreadList {
 public:
  ...
  // suspended state, such that the call to `RunCheckpoint` happens-before the end of _S_, and the
  // beginning of _S_ happened before _X_.  Thus after a RunCheckpoint() call, no preexisting
