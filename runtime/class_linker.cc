...
bool ClassLinker::LinkFieldsHelper::LinkFields(ClassLinker* class_linker,
  ...
  if (!is_static &&
    ...
    // that 'referent' is alphabetically last for instance fields, so this is easy...
    ...
    CHECK_EQ(&fields->At(klass->NumFields() - 1),
             WellKnownClasses::java_lang_ref_Reference_slowPathEnabled);
