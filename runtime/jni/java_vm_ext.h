...
class JavaVMExt : public JavaVM {
 public:
  ...
  void DisallowCCNewWeakGlobals() REQUIRES(!Locks::jni_weak_globals_lock_);
  void AllowCCNewWeakGlobals() REQUIRES(!Locks::jni_weak_globals_lock_);
 ...
 private:
  ...
  void WaitForWeakGlobalsProcessPrepare(Thread* self) REQUIRES_SHARED(Locks::mutator_lock_)
      REQUIRES(Locks::jni_weak_globals_lock_);
