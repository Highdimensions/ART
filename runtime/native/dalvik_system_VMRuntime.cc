...
static jint VMRuntime_getSdkExtensionNative([[maybe_unused]] JNIEnv* env,
                                            [[maybe_unused]] jclass klass,
                                            jstring attribute_name,
                                            jint default_value) {
  const char* raw_attribute_name = env->GetStringUTFChars(attribute_name, nullptr);
  std::string attribute_name_str(raw_attribute_name);
  return android::base::GetIntProperty(attribute_name_str, default_value);
}
...
static JNINativeMethod gMethods[] = {
    ...
    FAST_NATIVE_METHOD(VMRuntime, getSdkExtensionNative, "(Ljava/lang/String;I)I"),
