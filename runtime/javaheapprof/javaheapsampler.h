...
class HeapSampler {
 public:
  ...
  // If JHP is enabled, reports an allocation of the given size to perfetto.
  // This should be called for all allocations. Sampling is done internally to
  // reduce the performance overhead based on the sampling interval.
  void ReportAllocation(art::mirror::Object* obj, size_t allocation_size);
