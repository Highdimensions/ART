...
class TraceData {
 ...
 private:
  ...
  // These hold the methods and threads see so far. These are used to generate informaton about
...
class TraceProfiler {
 public:
  ...
  // placeholder method exit event and flush all method entry events.
