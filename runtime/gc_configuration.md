...
reducing browser memory use"](https://dl.acm.org/doi/10.1145/3563323). The ART approach is
...
some memory that remains fragmented after a GC. Some heap areas, e.g. those used for non-movable
objects, are also subject to (usually very small amounts of) fragmentation, and are treated
similarly.
