...
// Out-of-line definition of type strings, to allow comparison by pointer equality.
const char* const OatFileAssistant::OatFileInfo::kType = "none";
const char* const OatFileAssistant::OatFileInfoBackedByOat::kType = "oat";
const char* const OatFileAssistant::OatFileInfoBackedBySdm::kType = "sdm";
const char* const OatFileAssistant::OatFileInfoBackedByVdex::kType = "vdex";
const char* const OatFileAssistant::OatFileInfoBackedByDm::kType = "dm";
