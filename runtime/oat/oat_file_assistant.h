 ...
 private:
  class OatFileInfo {
   public:
    ...
    // information.
    static constexpr const char* kType = "none";
    virtual const char* GetType() { return kType; }
  ...
  class OatFileInfoBackedByOat : public OatFileInfo {
   public:
    ...
    static constexpr const char* kType = "oat";
  ...
  class OatFileInfoBackedByVdex : public OatFileInfo {
   public:
    ...
    static constexpr const char* kType = "vdex";
    const char* GetType() override { return kType; }
  ...
  class OatFileInfoBackedByDm : public OatFileInfo {
   public:
    ...
    static constexpr const char* kType = "dm";
    const char* GetType() override { return kType; }
  ...
  // Oat file info candidates, ordered by precedence, along with debug strings to indicate the
  // location.
  std::vector<std::pair<const char*, std::unique_ptr<OatFileInfo>>> info_list_;
