...
class Dex2oatEnvironmentTest : public Dex2oatScratchDirs, public CommonRuntimeTest {
 public:
  ...
  void CreateDexMetadata(const std::string& vdex,
    ...
    writer.StartAlignedEntry("primary.vdex", /*flags=*/0, /*alignment=*/page_aligned ? 16384 : 4);
  ...
  void CreateSecureDexMetadata(const std::string& odex,
    ...
    writer.StartAlignedEntry("primary.odex", /*flags=*/0, /*alignment=*/16384);
    ...
    if (!art.empty()) {
      ...
      writer.StartAlignedEntry("primary.art", /*flags=*/0, /*alignment=*/16384);
  ...
  void CreateSecureDexMetadataCompanion(const std::string& apex_versions,
