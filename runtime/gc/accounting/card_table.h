...
class CardTable {
 public:
  ...
  // Currently only used by CMC. Used to avoid rescanning (in the second pass
  // of the marking phase) cards which contain old-to-young references and have
  // not been dirtied since the first pass of marking.
