...
template <typename StorageType>
inline bool BitVectorView<StorageType>::Union(BitVectorView<StorageType> union_with) {
...
template <typename StorageType>
inline bool BitVectorView<StorageType>::UnionIfNotIn(BitVectorView<StorageType> union_with,
                                                     BitVectorView<StorageType> not_in) {
  DCHECK_EQ(SizeInBits(), union_with.SizeInBits());
