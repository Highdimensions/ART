...
extern "C" bool native_bridge8_getTrampolineForFunctionPointer(const void* ptr) {
  SetIsFunctionPointerExecutableWithNativeBridgeCalled(ptr);
  return true;
}
...
android::NativeBridgeCallbacks NativeBridgeItf{
    ...
    // v8
    &native_bridge8_isFunctionPointerExecutableWithNativeBridge,
};
