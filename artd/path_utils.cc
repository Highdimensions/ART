...
Result<std::string> BuildSecureDexMetadataPath(
    const SecureDexMetadataWithCompanionPaths& sdm_path) {
...
Result<std::string> BuildSecureDexMetadataCompanionPath(
    const SecureDexMetadataWithCompanionPaths& sdc_path) {
  std::string oat_path =
