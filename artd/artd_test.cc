...
TEST_F(ArtdPreRebootTest, preRebootInit) {
  ...
  EXPECT_CALL(*mock_pre_reboot_build_props_, GetProperty("ro.build.version.sdk"))
      .WillOnce(Return("35"));
  EXPECT_CALL(*mock_pre_reboot_build_props_, GetProperty("ro.build.version.codename"))
      .WillOnce(Return("Baklava"));
  EXPECT_CALL(*mock_pre_reboot_build_props_, GetProperty("ro.build.version.known_codenames"))
      .WillOnce(Return("VanillaIceCream,Baklava"));
