...
// Introduced in version 5 API, corresponding to SDK level 37.
palette_status_t PaletteGetPriorityMapping(int32_t managed_priority, int* result) {
  PaletteGetPriorityMappingMethod m =
