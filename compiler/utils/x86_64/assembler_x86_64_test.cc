...
TEST_F(AssemblerX86_64AVXTest, DisassVPminsb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpminsb, "vpminsb {reg1}, {reg2}, {reg3}"),
                  "disass-vpminsb");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPmaxsb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpmaxsb, "vpmaxsb {reg1}, {reg2}, {reg3}"),
                  "disass-vpmaxsb");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPminsd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpminsd, "vpminsd {reg1}, {reg2}, {reg3}"),
                  "disass-vpminsd");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPminuw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpminuw, "vpminuw {reg1}, {reg2}, {reg3}"),
                  "disass-vpminuw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPmaxuw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpmaxuw, "vpmaxuw {reg1}, {reg2}, {reg3}"),
                  "disass-vpmaxuw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPminud) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpminud, "vpminud {reg1}, {reg2}, {reg3}"),
                  "disass-vpminud");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPmaxud) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpmaxud, "vpmaxud {reg1}, {reg2}, {reg3}"),
                  "disass-vpmaxud");
}

TEST_F(AssemblerX86_64AVXTest, DisassVMinps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vminps, "vminps {reg1}, {reg2}, {reg3}"),
                  "disass-vminps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVMaxps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vmaxps, "vmaxps {reg1}, {reg2}, {reg3}"),
                  "disass-vmaxps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVMinpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vminpd, "vminpd {reg1}, {reg2}, {reg3}"),
                  "disass-vminpd");
}

TEST_F(AssemblerX86_64AVXTest, DisassVMaxpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vmaxpd, "vmaxpd {reg1}, {reg2}, {reg3}"),
                  "disass-vmaxpd");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPcmpgtq) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpcmpgtq, "vpcmpgtq {reg1}, {reg2}, {reg3}"),
                  "disass-vpcmpgtq");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPunpcklbw) {
  CustomDriverStr(
      VerifyDisassemblerDriver,
      RepeatVVV(&x86_64::X86_64Assembler::vpunpcklbw, "vpunpcklbw {reg1}, {reg2}, {reg3}"),
      "disass-vpunpcklbw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsllw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsllw, 4U, "vpsllw {reg2}, {reg1}, {imm}"),
                  "disass-vpsllw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPslld) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpslld, 5U, "vpslld {reg2}, {reg1}, {imm}"),
                  "disass-vpslld");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsllq) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsllq, 6U, "vpsllq {reg2}, {reg1}, {imm}"),
                  "disass-vpsllq");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsraw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsraw, 4U, "vpsraw {reg2}, {reg1}, {imm}"),
                  "disass-vpsraw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsrad) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsrad, 5U, "vpsrad {reg2}, {reg1}, {imm}"),
                  "disass-vpsrad");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsrlw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsrlw, 4U, "vpsrlw {reg2}, {reg1}, {imm}"),
                  "disass-vpsrlw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsrld) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsrld, 5U, "vpsrld {reg2}, {reg1}, {imm}"),
                  "disass-vpsrld");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPsrlq) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVIb(&x86_64::X86_64Assembler::vpsrlq, 6U, "vpsrlq {reg2}, {reg1}, {imm}"),
                  "disass-vpsrlq");
}
